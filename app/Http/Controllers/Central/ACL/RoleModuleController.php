...
class RoleModuleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return to_route('central.role-module.edit', $request->role_id)->with($result);
        } catch (\Throwable $th) {
            DB::rollback();
    ...
    public function edit(Role $role_module)
    {
        ...
        return Inertia::render('Central/ACL/RoleModule/Form', $returnArr);
    }
    ...
    public function destroy(RoleModule $role_module)
    {
        ...
        try {
            ...
            return to_route('central.role-module.edit', $role_id->slug)->with($result);
        } catch (\Throwable $th) {
            DB::rollback();
