...
class ModulePermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return to_route('tenant.module-permission.edit', $request->module_id)->with($result);
        } catch (\Throwable $th) {
            DB::rollback();
    ...
    public function edit(Module $module_permission)
    {
        ...
        return Inertia::render('Tenant/ACL/ModulePermission/Form', $returnArr);
    }
    ...
    public function destroy(ModulePermission $module_permission)
    {
        ...
        try {
            ...
            return to_route('tenant.module-permission.edit', $module_id->slug)->with($result);
        } catch (\Throwable $th) {
            DB::rollback();
