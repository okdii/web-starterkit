...
namespace App\Http\Controllers\Tenant\Menu;
...
class MenuController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Tenant/Menu/Index', $returnArr);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('Tenant/Menu/Form', $returnArr);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return to_route('tenant.menu.index')->with($result);
        } catch (\Throwable $th) {
            DB::rollback();
