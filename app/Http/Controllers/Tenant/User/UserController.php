...
class UserController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Tenant/User/Index', $returnArr);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('Tenant/User/Form', $returnArr);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return to_route('tenant.user.index')->with($result);
        } catch (\Throwable $th) {
            DB::rollback();
    ...
    public function show(User $user)
    {
        ...
        return Inertia::render('Tenant/User/Show', $returnArr);
    }
